...
Proyecto desarrollado como parte del **Taller 2 del curso de Spring**, cuyo objetivo es construir un **microservicio reactivo** que consuma la API pública de Pokémon ([https://pokeapi.co](https://pokeapi.co)) utilizando **Spring Boot + WebFlux + WebClient**.

> ⚠️ Este proyecto **NO usa** `RestTemplate` ni `spring-boot-starter-web`, ya que fue diseñado 100% reactivo siguiendo las indicaciones del taller.
...
| Compatibilidad | Java 21 y Spring Boot 3.5.x |
...
```
---
## 3️⃣ Alias directo a la versión Slim
...
---
El JSON OpenAPI (especificación) está disponible en:
